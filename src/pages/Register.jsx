...
const Register = () => {
  return (
    ...
    validationSchema={Yup.object({
        ...
        .required ('first name is mandetory')
        ...
        .required('email is mandetory'),

        password:Yup.string()
        .required ('password is mandetory')
        
        .matches(/^(?=.*[A-Za-z])(?=.*\d)(?=.*[@#$?&-_!])[A-Za-z\d@#$?&-_!]{8,50}$/,'weak password, password must be atleaset of 8 Characrher like:Ads@234'),

        cpassword:Yup.string()
        .required ('confirm password is mandetory')
