...
const Cart = () => {
  ...
  const removeCartHandler=id=>{
    ...
    if(confirmed){
        ...
        setItems(filterCart)
        toast.success('items is removed from the cart')
    }
  }
            ...
            <Fragment>
              ...
              <div className="col-md-3">
                <div className="shadow p-2">
                  ...
                  <hr />
                  <p>
                    <strong>Units:{items.reduce((a,b)=>a+Number(b.quantity),0)}</strong> (Units)
                  </p>
                  <p>
                    <strong>Total:{items.reduce((ac,item)=>ac+(item.quantity*item.price),0)}</strong>
                  </p>
                  <hr />
